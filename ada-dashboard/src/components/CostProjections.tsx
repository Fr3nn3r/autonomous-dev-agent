...
export function CostProjections({ className = '' }: CostProjectionsProps) {
  ...
  const confidenceColors = {
    low: 'text-red-500 dark:text-red-400 bg-red-500/10',
    medium: 'text-yellow-500 dark:text-yellow-400 bg-yellow-500/10',
    high: 'text-green-500 dark:text-green-400 bg-green-500/10',
  }
      ...
      <div className="p-4 space-y-4">
        ...
        <div className="grid grid-cols-2 gap-4">
          <div className="bg-gray-100 dark:bg-gray-700/50 rounded p-3">
            <p className="text-gray-500 dark:text-gray-400 text-sm">Features Completed</p>
            <p className="text-2xl font-bold text-green-600 dark:text-green-400">{projection.features_completed}</p>
          </div>
          <div className="bg-gray-100 dark:bg-gray-700/50 rounded p-3">
            <p className="text-gray-500 dark:text-gray-400 text-sm">Features Remaining</p>
            <p className="text-2xl font-bold text-blue-600 dark:text-blue-400">{projection.features_remaining}</p>
          </div>
        </div>
        ...
        <div className="space-y-2">
          ...
          <div className="flex justify-between items-center">
            <span className="text-gray-500 dark:text-gray-400">Avg Cost/Feature</span>
            <span className="font-medium">${projection.avg_cost_per_feature.toFixed(4)}</span>
          </div>
          <div className="flex justify-between items-center">
            <span className="text-gray-500 dark:text-gray-400">Daily Burn (7d)</span>
        ...
        {projection.features_remaining > 0 && projection.projected_remaining_cost_mid > 0 && (
          <div className="bg-gray-100 dark:bg-gray-700/50 rounded p-3">
            <p className="text-gray-500 dark:text-gray-400 text-sm mb-2">Projected Remaining Cost</p>
            <div className="space-y-1">
              ...
              <div className="flex justify-between text-sm">
                <span className="text-yellow-600 dark:text-yellow-400">Worst case</span>
        ...
        {projection.features_remaining === 0 && (
          <div className="flex items-center gap-2 text-green-600 dark:text-green-400 bg-green-500/10 rounded p-3">
